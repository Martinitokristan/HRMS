...
const SelectItem = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      " data-[state=checked]:bg-blue-300 data-[state=checked]:text-blue-900 data-[state=checked]:font-semibold" +
      " data-[state=checked]:focus:bg-blue-300 data-[state=checked]:data-[highlighted]:bg-blue-300" +
