...
const RiderSettings = ({ onBack }) => {
    ...
    const [profileData, setProfileData] = useState({
        ...
        address:
            user?.rider_profile?.address || user?.riderProfile?.address || "",
    });
        ...
        <main className="min-h-screen bg-secondary/30">
            <div className="max-w-xl mx-auto px-5 py-8">
                ...
                {message.text && (
                    <Card
                        role="alert"
                        className={`p-4 mb-6 flex items-center gap-3 font-medium text-sm ${
                        ...
                        <Card className="p-6">
                            ...
                            <div className="flex flex-col items-center mb-6">
                                <div className="relative">
                                    ...
                                    <label
                                        title="Change Photo"
                                        className="absolute -bottom-1 -right-1 bg-primary text-white w-9 h-9 rounded-xl flex items-center justify-center cursor-pointer border-[3px] border-white shadow"
                                    >
                        ...
                        <Card className="p-6">
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    variant="secondary"
                                    disabled={loading}
                                    className="w-full mt-2 bg-foreground text-white hover:bg-foreground/90"
                                >
                                    {loading
                                        ? "Processing..."
                                        : "Update Password"}
