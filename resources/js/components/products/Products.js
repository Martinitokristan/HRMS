    ...
    const fetchData = async (silent = false) => {
        ...
        try {
            const res = await api.get("/products", {
                params: { page, search, category_id: categoryFilter },
            });
                                    ...
                                    >
                                        <TableCell className="px-4 py-3">
                                            <div className="flex items-center gap-3">
                                                <div className="relative h-12 w-12 rounded-xl overflow-hidden bg-secondary border-2 border-border flex-shrink-0">
                                                    ...
                                                    <div
                                                        className={`absolute inset-0 flex items-center justify-center ${imgSrc ? "hidden" : "flex"}`}
                                                    >
                                        ...
                                        <TableCell className="px-4 py-3">
                                            ...
                                            <div className="text-xs text-muted-foreground mt-0.5">
                                                {p.supplier?.name || "In-house"}
                                            </div>
                                            {p.brand && (
                                                <div className="text-[10px] font-semibold text-orange-500 mt-0.5">
                                                    {p.brand.name}
                                                </div>
                                            )}
                                        </TableCell>
                                        ...
                                        <TableCell className="px-4 py-3 text-center">
                                            <Badge
                                                variant="outline"
                                                className={`font-bold ${margin > 20 ? "border-success/30 bg-success-light text-success-foreground" : "border-warning/30 bg-warning-light text-warning-foreground"}`}
                                            >
                                                {margin}%
                                            </Badge>
                                        </TableCell>
