...
export default function SupplierRegister() {
    ...
    const handleResend = async () => {
        ...
        try {
            const response = await api.post(
                "/supplier/auth/resend-verification",
            ...
            <div className="relative flex items-center justify-center p-8 overflow-y-auto">
                <div className="w-full max-w-lg">
                    ...
                    <p className="text-gray-500 mb-8">
                        Create your supplier account to manage catalog and
                        purchase orders with HRMS.
                    </p>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        ...
                                        {capsWarning && (
                                            <p className="text-xs text-orange-500 my-1 font-semibold">
                                                Caps Lock is on!
                                            </p>
                                        )}
                                        {errors.password && (
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            <Input
                                                ...
                                                className={`pr-11 ${errors.password_confirmation ? "border-red-500" : ""}`}
                                            />
                                            <button
                                                type="button"
                                                onClick={() =>
