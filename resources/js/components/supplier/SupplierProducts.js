...
export default function SupplierProducts() {
    ...
    const openEdit = (product) => {
        ...
        const productVariants = (product.variants || []).map(v => ({
            ...
            stock: v.stock || 0, price_override: v.price_override || '', barcode_suffix: v.barcode_suffix || '',
    ...
    const addVariant = () => {
        setVariants(prev => [...prev, { size: '', color: '', weight: '', stock: 0, price_override: '', barcode_suffix: '', existing_image_path: null }]);
    };
                            ...
                            <Card className="p-5">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1.5">
                                        <Label>Barcode</Label>
                                        <Input type="text" value={form.barcode} onChange={e => setForm({ ...form, barcode: e.target.value })} placeholder="Auto-generated if empty" />
                                    </div>
                                    <div className="space-y-1.5">
