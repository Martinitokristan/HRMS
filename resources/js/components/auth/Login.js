        ...
        <div className="flex min-h-screen">
            ...
            <div className="flex flex-1 items-center justify-center px-6 py-12 bg-card">
                <div className="w-full max-w-[420px] relative">
                    ...
                    <h1 className="text-[26px] font-black text-foreground tracking-tight mb-2">
                        Sign In to Your Account
                    </h1>
                    <p className="text-sm text-muted-foreground mb-8">
                        Access customer, rider, supplier, or admin tools using
            ...
            >
                <div
                    ...
                    style={{
                        backgroundImage:
                            "radial-gradient(circle at 50% 30%, #FF6B35, transparent 60%)",
                    }}
                />
                <div className="relative z-10 text-center max-w-sm">
                    ...
                    <h2 className="text-2xl font-black mb-3">
                        Shop Smarter with HRMS
                    </h2>
                    <p className="text-slate-400 text-sm leading-relaxed mb-8">
                        Your one-stop hardware store. Browse products, place
                        orders, and track deliveries all from one account.
                    </p>
