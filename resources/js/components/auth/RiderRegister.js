...
export default function RiderRegister() {
    ...
    const handleChange = (field, value) => {
        ...
        if (field === "password" && form.password_confirmation) {
            if (newValue !== form.password_confirmation)
                setError("password_confirmation", "Passwords do not match");
            else clearError("password_confirmation");
        }
    };
            ...
            <div className="relative flex items-center justify-center p-8 overflow-y-auto">
                <div className="w-full max-w-lg">
                    ...
                    <p className="text-base text-gray-500 mb-8">
                        Create your rider account to apply for delivery
                        assignments.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        <Input
                                            ...
                                            className={`text-sm file:mr-3 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-primary/10 file:text-primary hover:file:bg-primary/20 ${errors.valid_id_file ? "border-red-500" : ""}`}
                                        />
                                    </div>
                                    {errors.valid_id_file && (
                        ...
                        <Button
                            type="submit"
                            disabled={submitting}
                            className="w-full h-12 text-[15px] font-bold bg-[#F97316] hover:bg-orange-600 text-white shadow-lg shadow-orange-500/25"
                        >
                            {submitting ? (
                                <>
