...
export default function Riders() {
    ...
    const handleScheduleInterview = async (id) => {
        ...
        if (!datetime) return;
        try {
            await api.post(`/riders/${id}/interview`, {
            ...
            <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
                <div>
                    <h2 className="text-xl font-bold text-foreground tracking-tight flex items-center gap-2">
                        <Bike className="h-6 w-6 text-primary" /> Rider Fleet &
                        Pipeline
                    </h2>
                    <p className="text-sm text-muted-foreground mt-0.5">
                        Manage rider applications and track fleet performance
                    </p>
                </div>
            </div>
                                    ...
                                    <TableCell className="px-4 py-3">
                                        <div className="text-sm">
                                            <div className="font-semibold text-primary">
                                                {r.rider_profile?.vehicle_type}{" "}
                                                -{" "}
                                                {r.rider_profile?.vehicle_model}{" "}
                                    ...
                                    <TableCell className="px-4 py-3">
                                        <div className="flex items-center gap-1">
                                            ...
                                            {r.status === "active" && (
                                                <Badge
                                                    variant="outline"
                                                    className="border-success/30 bg-success-light text-success-foreground text-[11px]"
                                                >
                                                    On Duty
                                                </Badge>
                                            )}
